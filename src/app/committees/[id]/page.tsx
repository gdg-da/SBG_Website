            ...
            <section className="relative overflow-hidden bg-theme-black">
                ...
                <div className="container relative z-10 px-4 py-16 md:px-6">
                    <div className="mx-auto max-w-4xl text-center">
                        <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl"><span className="bg-gradient-to-r from-theme-yellow to-theme-red bg-clip-text text-transparent">{committee.name}</span></h1>
                        <p className="mt-4 text-xl text-muted-foreground">{committee.description}</p>
                    </div>
                </div>
