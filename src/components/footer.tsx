        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              SBG DAU, Gandhinagar, Gujarat, India
            </p>
            <div className="flex space-x-4">
              <a href="mailto:sbg@dau.ac.in" target="_blank" className="text-muted-foreground hover:text-theme-red">
                sbg@dau.ac.in
              </a>
              {/* <Link
                href="#"
                className="group flex h-8 w-8 items-center justify-center rounded-full bg-theme-gray-light/30 text-muted-foreground transition-colors hover:bg-theme-red hover:text-white"
              >
          ...
          <div className='flex justify-center items-center w-full'>
            <div className='mt-8 w-1/2 border-t border-theme-gray-light pt-8 text-center text-sm text-muted-foreground'>
                <Link
                    ...
                    className="group relative text-muted-foreground hover:text-theme-red"
                >
